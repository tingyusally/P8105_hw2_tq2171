...
# Print the results
print(average_viewership_season1)
print(average_viewership_season5)
```
The average viewship for season1 (series1) is 2.77, and the average viewship for season5 (series5) is 10.0393